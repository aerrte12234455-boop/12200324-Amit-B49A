      ...
      <div className={seatSelectorStyles.mainContainer}>
        ...
        <div className={seatSelectorStyles.headerContainer}>
          ...
          <div className={seatSelectorStyles.titleContainer}>
            <h1 className={seatSelectorStyles.movieTitle}>
              {movie?.title}
            </h1>
                          ...
                          <button
                            ...
                            title={
                              isBooked
                                ...
                                : `Seat ${id} (${row.type}) - ₹${
                                    row.type === "recliner" ? Math.round(basePrice * 1.5) : basePrice
                                  }`
                            }
                          >
            ...
            <div className={seatSelectorStyles.summaryContainer}>
              ...
              <div className="space-y-4">
                ...
                <div className={seatSelectorStyles.actionButtons}>
                  <button onClick={clearSelection} disabled={selectedCount === 0} className={seatSelectorStyles.clearButton}>Clear</button>
                  <button onClick={confirmBooking} disabled={selectedCount === 0} className={seatSelectorStyles.confirmButton}>Confirm Booking</button>
                </div>
              </div>
            </div>
            ...
            <div className={seatSelectorStyles.pricingContainer}>
              ...
              <div className="space-y-3">
                <div className={seatSelectorStyles.pricingItem}>
                  <div className={seatSelectorStyles.pricingRow}>
                    <div className={seatSelectorStyles.pricingLabel}>Standard</div>
                    <div className={seatSelectorStyles.pricingValueStandard}>₹{basePrice}</div>
                  </div>
                </div>
                <div className={seatSelectorStyles.pricingItem}>
                  <div className={seatSelectorStyles.pricingRow}>
                    <div className={seatSelectorStyles.pricingLabel}>Recliner</div>
                    <div className={seatSelectorStyles.pricingValueRecliner}>₹{Math.round(basePrice * 1.5)}</div>
                  </div>
                </div>
