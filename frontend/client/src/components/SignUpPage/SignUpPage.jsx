...
import { ArrowLeft, Eye, EyeOff, User, Mail, Lock, Calendar, Film, Clapperboard, Ticket, Phone } from 'lucide-react';
...
const SignUpPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('📝 Form Submission Data:', {
      ...formData,
      password: '***' + formData.password.slice(-2) // Hide full password for security
    });
